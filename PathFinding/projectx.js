...
function createWasm() {
  ...
  /** @param {WebAssembly.Module=} module*/ function receiveInstance(instance, module) {
    ...
    wasmMemory = wasmExports["jh"];
    updateMemoryViews();
    wasmTable = wasmExports["lh"];
    addOnInit(wasmExports["kh"]);
...
var ASM_CONSTS = {
  ...
  6527104: () => window.innerWidth,
  6527134: () => window.innerHeight
};
...
var wasmImports = {
  ...
  /** @export */ ih: ___syscall_dup3,
  /** @export */ F: ___syscall_fcntl64,
  /** @export */ hh: ___syscall_fstat64,
  /** @export */ gh: ___syscall_getdents64,
  /** @export */ fh: ___syscall_ioctl,
  /** @export */ eh: ___syscall_lstat64,
  /** @export */ dh: ___syscall_newfstatat,
  /** @export */ R: ___syscall_openat,
  /** @export */ ch: ___syscall_readlinkat,
  /** @export */ bh: ___syscall_renameat,
  /** @export */ ah: ___syscall_rmdir,
  /** @export */ $g: ___syscall_stat64,
  /** @export */ Ma: ___syscall_unlinkat,
  /** @export */ Yg: __abort_js,
  /** @export */ Xg: __emscripten_fs_load_embedded_files,
  /** @export */ Wg: __emscripten_get_now_is_monotonic,
  /** @export */ Vg: __emscripten_memcpy_js,
  /** @export */ Ug: __emscripten_system,
  /** @export */ Tg: __emscripten_throw_longjmp,
  /** @export */ ib: __gmtime_js,
  /** @export */ jb: __localtime_js,
  /** @export */ kb: __mktime_js,
  /** @export */ gb: __mmap_js,
  /** @export */ hb: __munmap_js,
  /** @export */ Sg: __tzset_js,
  /** @export */ Rg: _eglBindAPI,
  /** @export */ Qg: _eglChooseConfig,
  /** @export */ Pg: _eglCreateContext,
  /** @export */ Og: _eglCreateWindowSurface,
  /** @export */ Ng: _eglDestroyContext,
  /** @export */ Mg: _eglDestroySurface,
  /** @export */ Lg: _eglGetConfigAttrib,
  /** @export */ Ja: _eglGetDisplay,
  /** @export */ Kg: _eglGetError,
  /** @export */ Jg: _eglInitialize,
  /** @export */ Ig: _eglMakeCurrent,
  /** @export */ Hg: _eglQueryString,
  /** @export */ Gg: _eglSwapBuffers,
  /** @export */ Fg: _eglSwapInterval,
  /** @export */ Eg: _eglTerminate,
  /** @export */ Dg: _eglWaitGL,
  /** @export */ Cg: _eglWaitNative,
  /** @export */ Bg: _emscripten_asm_const_int,
  /** @export */ d: _emscripten_asm_const_int_sync_on_main_thread,
  /** @export */ Ia: _emscripten_asm_const_ptr_sync_on_main_thread,
  /** @export */ C: _emscripten_date_now,
  /** @export */ Ag: _emscripten_exit_fullscreen,
  /** @export */ zg: _emscripten_exit_pointerlock,
  /** @export */ B: _emscripten_get_device_pixel_ratio,
  /** @export */ s: _emscripten_get_element_css_size,
  /** @export */ Ha: _emscripten_get_gamepad_status,
  /** @export */ A: _emscripten_get_now,
  /** @export */ yg: _emscripten_get_num_gamepads,
  /** @export */ xg: _emscripten_get_screen_size,
  /** @export */ wg: _emscripten_glActiveTexture,
  /** @export */ vg: _emscripten_glAttachShader,
  /** @export */ ug: _emscripten_glBeginQuery,
  /** @export */ tg: _emscripten_glBeginQueryEXT,
  /** @export */ sg: _emscripten_glBeginTransformFeedback,
  /** @export */ rg: _emscripten_glBindAttribLocation,
  /** @export */ qg: _emscripten_glBindBuffer,
  /** @export */ pg: _emscripten_glBindBufferBase,
  /** @export */ og: _emscripten_glBindBufferRange,
  /** @export */ ng: _emscripten_glBindFramebuffer,
  /** @export */ mg: _emscripten_glBindRenderbuffer,
  /** @export */ lg: _emscripten_glBindSampler,
  /** @export */ kg: _emscripten_glBindTexture,
  /** @export */ jg: _emscripten_glBindTransformFeedback,
  /** @export */ ig: _emscripten_glBindVertexArray,
  /** @export */ hg: _emscripten_glBindVertexArrayOES,
  /** @export */ gg: _emscripten_glBlendColor,
  /** @export */ fg: _emscripten_glBlendEquation,
  /** @export */ eg: _emscripten_glBlendEquationSeparate,
  /** @export */ dg: _emscripten_glBlendFunc,
  /** @export */ cg: _emscripten_glBlendFuncSeparate,
  /** @export */ bg: _emscripten_glBlitFramebuffer,
  /** @export */ ag: _emscripten_glBufferData,
  /** @export */ $f: _emscripten_glBufferSubData,
  /** @export */ _f: _emscripten_glCheckFramebufferStatus,
  /** @export */ Zf: _emscripten_glClear,
  /** @export */ Yf: _emscripten_glClearBufferfi,
  /** @export */ Xf: _emscripten_glClearBufferfv,
  /** @export */ Wf: _emscripten_glClearBufferiv,
  /** @export */ Vf: _emscripten_glClearBufferuiv,
  /** @export */ Uf: _emscripten_glClearColor,
  /** @export */ Tf: _emscripten_glClearDepthf,
  /** @export */ Sf: _emscripten_glClearStencil,
  /** @export */ Rf: _emscripten_glClientWaitSync,
  /** @export */ Qf: _emscripten_glColorMask,
  /** @export */ Pf: _emscripten_glCompileShader,
  /** @export */ Of: _emscripten_glCompressedTexImage2D,
  /** @export */ Nf: _emscripten_glCompressedTexImage3D,
  /** @export */ Mf: _emscripten_glCompressedTexSubImage2D,
  /** @export */ Lf: _emscripten_glCompressedTexSubImage3D,
  /** @export */ Kf: _emscripten_glCopyBufferSubData,
  /** @export */ Jf: _emscripten_glCopyTexImage2D,
  /** @export */ If: _emscripten_glCopyTexSubImage2D,
  /** @export */ Hf: _emscripten_glCopyTexSubImage3D,
  /** @export */ Gf: _emscripten_glCreateProgram,
  /** @export */ Ff: _emscripten_glCreateShader,
  /** @export */ Ef: _emscripten_glCullFace,
  /** @export */ Df: _emscripten_glDeleteBuffers,
  /** @export */ Cf: _emscripten_glDeleteFramebuffers,
  /** @export */ Bf: _emscripten_glDeleteProgram,
  /** @export */ Af: _emscripten_glDeleteQueries,
  /** @export */ zf: _emscripten_glDeleteQueriesEXT,
  /** @export */ yf: _emscripten_glDeleteRenderbuffers,
  /** @export */ xf: _emscripten_glDeleteSamplers,
  /** @export */ wf: _emscripten_glDeleteShader,
  /** @export */ vf: _emscripten_glDeleteSync,
  /** @export */ uf: _emscripten_glDeleteTextures,
  /** @export */ tf: _emscripten_glDeleteTransformFeedbacks,
  /** @export */ sf: _emscripten_glDeleteVertexArrays,
  /** @export */ rf: _emscripten_glDeleteVertexArraysOES,
  /** @export */ qf: _emscripten_glDepthFunc,
  /** @export */ pf: _emscripten_glDepthMask,
  /** @export */ of: _emscripten_glDepthRangef,
  /** @export */ nf: _emscripten_glDetachShader,
  /** @export */ mf: _emscripten_glDisable,
  /** @export */ lf: _emscripten_glDisableVertexAttribArray,
  /** @export */ kf: _emscripten_glDrawArrays,
  /** @export */ jf: _emscripten_glDrawArraysInstanced,
  /** @export */ hf: _emscripten_glDrawArraysInstancedANGLE,
  /** @export */ gf: _emscripten_glDrawArraysInstancedARB,
  /** @export */ ff: _emscripten_glDrawArraysInstancedEXT,
  /** @export */ ef: _emscripten_glDrawArraysInstancedNV,
  /** @export */ df: _emscripten_glDrawBuffers,
  /** @export */ cf: _emscripten_glDrawBuffersEXT,
  /** @export */ bf: _emscripten_glDrawBuffersWEBGL,
  /** @export */ af: _emscripten_glDrawElements,
  /** @export */ $e: _emscripten_glDrawElementsInstanced,
  /** @export */ _e: _emscripten_glDrawElementsInstancedANGLE,
  /** @export */ Ze: _emscripten_glDrawElementsInstancedARB,
  /** @export */ Ye: _emscripten_glDrawElementsInstancedEXT,
  /** @export */ Xe: _emscripten_glDrawElementsInstancedNV,
  /** @export */ We: _emscripten_glDrawRangeElements,
  /** @export */ Ve: _emscripten_glEnable,
  /** @export */ Ue: _emscripten_glEnableVertexAttribArray,
  /** @export */ Te: _emscripten_glEndQuery,
  /** @export */ Se: _emscripten_glEndQueryEXT,
  /** @export */ Re: _emscripten_glEndTransformFeedback,
  /** @export */ Qe: _emscripten_glFenceSync,
  /** @export */ Pe: _emscripten_glFinish,
  /** @export */ Oe: _emscripten_glFlush,
  /** @export */ Ne: _emscripten_glFlushMappedBufferRange,
  /** @export */ Me: _emscripten_glFramebufferRenderbuffer,
  /** @export */ Le: _emscripten_glFramebufferTexture2D,
  /** @export */ Ke: _emscripten_glFramebufferTextureLayer,
  /** @export */ Je: _emscripten_glFrontFace,
  /** @export */ Ie: _emscripten_glGenBuffers,
  /** @export */ He: _emscripten_glGenFramebuffers,
  /** @export */ Ge: _emscripten_glGenQueries,
  /** @export */ Fe: _emscripten_glGenQueriesEXT,
  /** @export */ Ee: _emscripten_glGenRenderbuffers,
  /** @export */ De: _emscripten_glGenSamplers,
  /** @export */ Ce: _emscripten_glGenTextures,
  /** @export */ Be: _emscripten_glGenTransformFeedbacks,
  /** @export */ Ae: _emscripten_glGenVertexArrays,
  /** @export */ ze: _emscripten_glGenVertexArraysOES,
  /** @export */ ye: _emscripten_glGenerateMipmap,
  /** @export */ xe: _emscripten_glGetActiveAttrib,
  /** @export */ we: _emscripten_glGetActiveUniform,
  /** @export */ ve: _emscripten_glGetActiveUniformBlockName,
  /** @export */ ue: _emscripten_glGetActiveUniformBlockiv,
  /** @export */ te: _emscripten_glGetActiveUniformsiv,
  /** @export */ se: _emscripten_glGetAttachedShaders,
  /** @export */ re: _emscripten_glGetAttribLocation,
  /** @export */ qe: _emscripten_glGetBooleanv,
  /** @export */ pe: _emscripten_glGetBufferParameteri64v,
  /** @export */ oe: _emscripten_glGetBufferParameteriv,
  /** @export */ ne: _emscripten_glGetBufferPointerv,
  /** @export */ me: _emscripten_glGetError,
  /** @export */ le: _emscripten_glGetFloatv,
  /** @export */ ke: _emscripten_glGetFragDataLocation,
  /** @export */ je: _emscripten_glGetFramebufferAttachmentParameteriv,
  /** @export */ ie: _emscripten_glGetInteger64i_v,
  /** @export */ he: _emscripten_glGetInteger64v,
  /** @export */ ge: _emscripten_glGetIntegeri_v,
  /** @export */ fe: _emscripten_glGetIntegerv,
  /** @export */ ee: _emscripten_glGetInternalformativ,
  /** @export */ de: _emscripten_glGetProgramBinary,
  /** @export */ ce: _emscripten_glGetProgramInfoLog,
  /** @export */ be: _emscripten_glGetProgramiv,
  /** @export */ ae: _emscripten_glGetQueryObjecti64vEXT,
  /** @export */ $d: _emscripten_glGetQueryObjectivEXT,
  /** @export */ _d: _emscripten_glGetQueryObjectui64vEXT,
  /** @export */ Zd: _emscripten_glGetQueryObjectuiv,
  /** @export */ Yd: _emscripten_glGetQueryObjectuivEXT,
  /** @export */ Xd: _emscripten_glGetQueryiv,
  /** @export */ Wd: _emscripten_glGetQueryivEXT,
  /** @export */ Vd: _emscripten_glGetRenderbufferParameteriv,
  /** @export */ Ud: _emscripten_glGetSamplerParameterfv,
  /** @export */ Td: _emscripten_glGetSamplerParameteriv,
  /** @export */ Sd: _emscripten_glGetShaderInfoLog,
  /** @export */ Rd: _emscripten_glGetShaderPrecisionFormat,
  /** @export */ Qd: _emscripten_glGetShaderSource,
  /** @export */ Pd: _emscripten_glGetShaderiv,
  /** @export */ Od: _emscripten_glGetString,
  /** @export */ Nd: _emscripten_glGetStringi,
  /** @export */ Md: _emscripten_glGetSynciv,
  /** @export */ Ld: _emscripten_glGetTexParameterfv,
  /** @export */ Kd: _emscripten_glGetTexParameteriv,
  /** @export */ Jd: _emscripten_glGetTransformFeedbackVarying,
  /** @export */ Id: _emscripten_glGetUniformBlockIndex,
  /** @export */ Hd: _emscripten_glGetUniformIndices,
  /** @export */ Gd: _emscripten_glGetUniformLocation,
  /** @export */ Fd: _emscripten_glGetUniformfv,
  /** @export */ Ed: _emscripten_glGetUniformiv,
  /** @export */ Dd: _emscripten_glGetUniformuiv,
  /** @export */ Cd: _emscripten_glGetVertexAttribIiv,
  /** @export */ Bd: _emscripten_glGetVertexAttribIuiv,
  /** @export */ Ad: _emscripten_glGetVertexAttribPointerv,
  /** @export */ zd: _emscripten_glGetVertexAttribfv,
  /** @export */ yd: _emscripten_glGetVertexAttribiv,
  /** @export */ xd: _emscripten_glHint,
  /** @export */ wd: _emscripten_glInvalidateFramebuffer,
  /** @export */ vd: _emscripten_glInvalidateSubFramebuffer,
  /** @export */ ud: _emscripten_glIsBuffer,
  /** @export */ td: _emscripten_glIsEnabled,
  /** @export */ sd: _emscripten_glIsFramebuffer,
  /** @export */ rd: _emscripten_glIsProgram,
  /** @export */ qd: _emscripten_glIsQuery,
  /** @export */ pd: _emscripten_glIsQueryEXT,
  /** @export */ od: _emscripten_glIsRenderbuffer,
  /** @export */ nd: _emscripten_glIsSampler,
  /** @export */ md: _emscripten_glIsShader,
  /** @export */ ld: _emscripten_glIsSync,
  /** @export */ kd: _emscripten_glIsTexture,
  /** @export */ jd: _emscripten_glIsTransformFeedback,
  /** @export */ id: _emscripten_glIsVertexArray,
  /** @export */ hd: _emscripten_glIsVertexArrayOES,
  /** @export */ gd: _emscripten_glLineWidth,
  /** @export */ fd: _emscripten_glLinkProgram,
  /** @export */ ed: _emscripten_glMapBufferRange,
  /** @export */ dd: _emscripten_glPauseTransformFeedback,
  /** @export */ cd: _emscripten_glPixelStorei,
  /** @export */ bd: _emscripten_glPolygonOffset,
  /** @export */ ad: _emscripten_glProgramBinary,
  /** @export */ $c: _emscripten_glProgramParameteri,
  /** @export */ _c: _emscripten_glQueryCounterEXT,
  /** @export */ Zc: _emscripten_glReadBuffer,
  /** @export */ Yc: _emscripten_glReadPixels,
  /** @export */ Xc: _emscripten_glReleaseShaderCompiler,
  /** @export */ Wc: _emscripten_glRenderbufferStorage,
  /** @export */ Vc: _emscripten_glRenderbufferStorageMultisample,
  /** @export */ Uc: _emscripten_glResumeTransformFeedback,
  /** @export */ Tc: _emscripten_glSampleCoverage,
  /** @export */ Sc: _emscripten_glSamplerParameterf,
  /** @export */ Rc: _emscripten_glSamplerParameterfv,
  /** @export */ Qc: _emscripten_glSamplerParameteri,
  /** @export */ Pc: _emscripten_glSamplerParameteriv,
  /** @export */ Oc: _emscripten_glScissor,
  /** @export */ Nc: _emscripten_glShaderBinary,
  /** @export */ Mc: _emscripten_glShaderSource,
  /** @export */ Lc: _emscripten_glStencilFunc,
  /** @export */ Kc: _emscripten_glStencilFuncSeparate,
  /** @export */ Jc: _emscripten_glStencilMask,
  /** @export */ Ic: _emscripten_glStencilMaskSeparate,
  /** @export */ Hc: _emscripten_glStencilOp,
  /** @export */ Gc: _emscripten_glStencilOpSeparate,
  /** @export */ Fc: _emscripten_glTexImage2D,
  /** @export */ Ec: _emscripten_glTexImage3D,
  /** @export */ Dc: _emscripten_glTexParameterf,
  /** @export */ Cc: _emscripten_glTexParameterfv,
  /** @export */ Bc: _emscripten_glTexParameteri,
  /** @export */ Ac: _emscripten_glTexParameteriv,
  /** @export */ zc: _emscripten_glTexStorage2D,
  /** @export */ yc: _emscripten_glTexStorage3D,
  /** @export */ xc: _emscripten_glTexSubImage2D,
  /** @export */ wc: _emscripten_glTexSubImage3D,
  /** @export */ vc: _emscripten_glTransformFeedbackVaryings,
  /** @export */ uc: _emscripten_glUniform1f,
  /** @export */ tc: _emscripten_glUniform1fv,
  /** @export */ sc: _emscripten_glUniform1i,
  /** @export */ rc: _emscripten_glUniform1iv,
  /** @export */ qc: _emscripten_glUniform1ui,
  /** @export */ pc: _emscripten_glUniform1uiv,
  /** @export */ oc: _emscripten_glUniform2f,
  /** @export */ nc: _emscripten_glUniform2fv,
  /** @export */ mc: _emscripten_glUniform2i,
  /** @export */ lc: _emscripten_glUniform2iv,
  /** @export */ kc: _emscripten_glUniform2ui,
  /** @export */ jc: _emscripten_glUniform2uiv,
  /** @export */ ic: _emscripten_glUniform3f,
  /** @export */ hc: _emscripten_glUniform3fv,
  /** @export */ gc: _emscripten_glUniform3i,
  /** @export */ fc: _emscripten_glUniform3iv,
  /** @export */ ec: _emscripten_glUniform3ui,
  /** @export */ dc: _emscripten_glUniform3uiv,
  /** @export */ cc: _emscripten_glUniform4f,
  /** @export */ bc: _emscripten_glUniform4fv,
  /** @export */ ac: _emscripten_glUniform4i,
  /** @export */ $b: _emscripten_glUniform4iv,
  /** @export */ _b: _emscripten_glUniform4ui,
  /** @export */ Zb: _emscripten_glUniform4uiv,
  /** @export */ Yb: _emscripten_glUniformBlockBinding,
  /** @export */ Xb: _emscripten_glUniformMatrix2fv,
  /** @export */ Wb: _emscripten_glUniformMatrix2x3fv,
  /** @export */ Vb: _emscripten_glUniformMatrix2x4fv,
  /** @export */ Ub: _emscripten_glUniformMatrix3fv,
  /** @export */ Tb: _emscripten_glUniformMatrix3x2fv,
  /** @export */ Sb: _emscripten_glUniformMatrix3x4fv,
  /** @export */ Rb: _emscripten_glUniformMatrix4fv,
  /** @export */ Qb: _emscripten_glUniformMatrix4x2fv,
  /** @export */ Pb: _emscripten_glUniformMatrix4x3fv,
  /** @export */ Ob: _emscripten_glUnmapBuffer,
  ...
  /** @export */ Db: _emscripten_glVertexAttribDivisor,
  /** @export */ Cb: _emscripten_glVertexAttribDivisorANGLE,
  /** @export */ Bb: _emscripten_glVertexAttribDivisorARB,
  /** @export */ Ab: _emscripten_glVertexAttribDivisorEXT,
  /** @export */ zb: _emscripten_glVertexAttribDivisorNV,
  /** @export */ yb: _emscripten_glVertexAttribI4i,
  /** @export */ xb: _emscripten_glVertexAttribI4iv,
  /** @export */ wb: _emscripten_glVertexAttribI4ui,
  /** @export */ vb: _emscripten_glVertexAttribI4uiv,
  /** @export */ ub: _emscripten_glVertexAttribIPointer,
  /** @export */ tb: _emscripten_glVertexAttribPointer,
  /** @export */ sb: _emscripten_glViewport,
  /** @export */ rb: _emscripten_glWaitSync,
  /** @export */ Q: _emscripten_has_asyncify,
  /** @export */ qb: _emscripten_request_fullscreen_strategy,
  /** @export */ Ga: _emscripten_request_pointerlock,
  /** @export */ pb: _emscripten_resize_heap,
  /** @export */ Fa: _emscripten_sample_gamepad_data,
  /** @export */ Ea: _emscripten_set_beforeunload_callback_on_thread,
  /** @export */ Da: _emscripten_set_blur_callback_on_thread,
  /** @export */ z: _emscripten_set_canvas_element_size,
  /** @export */ P: _emscripten_set_element_css_size,
  /** @export */ Ca: _emscripten_set_focus_callback_on_thread,
  /** @export */ Ba: _emscripten_set_fullscreenchange_callback_on_thread,
  /** @export */ Aa: _emscripten_set_gamepadconnected_callback_on_thread,
  /** @export */ za: _emscripten_set_gamepaddisconnected_callback_on_thread,
  /** @export */ ya: _emscripten_set_keydown_callback_on_thread,
  /** @export */ xa: _emscripten_set_keypress_callback_on_thread,
  /** @export */ wa: _emscripten_set_keyup_callback_on_thread,
  /** @export */ ob: _emscripten_set_main_loop_arg,
  /** @export */ va: _emscripten_set_mousedown_callback_on_thread,
  /** @export */ ua: _emscripten_set_mouseenter_callback_on_thread,
  /** @export */ ta: _emscripten_set_mouseleave_callback_on_thread,
  /** @export */ sa: _emscripten_set_mousemove_callback_on_thread,
  /** @export */ ra: _emscripten_set_mouseup_callback_on_thread,
  /** @export */ qa: _emscripten_set_pointerlockchange_callback_on_thread,
  /** @export */ pa: _emscripten_set_resize_callback_on_thread,
  /** @export */ oa: _emscripten_set_touchcancel_callback_on_thread,
  /** @export */ na: _emscripten_set_touchend_callback_on_thread,
  /** @export */ ma: _emscripten_set_touchmove_callback_on_thread,
  /** @export */ la: _emscripten_set_touchstart_callback_on_thread,
  /** @export */ ka: _emscripten_set_visibilitychange_callback_on_thread,
  /** @export */ ja: _emscripten_set_wheel_callback_on_thread,
  /** @export */ nb: _emscripten_set_window_title,
  /** @export */ E: _emscripten_sleep,
  /** @export */ _g: _environ_get,
  /** @export */ Zg: _environ_sizes_get,
  /** @export */ mb: _exit,
  /** @export */ D: _fd_close,
  /** @export */ La: _fd_read,
  /** @export */ lb: _fd_seek,
  /** @export */ Ka: _fd_write,
  /** @export */ r: _glActiveTexture,
  /** @export */ ia: _glAttachShader,
  /** @export */ b: _glBindBuffer,
  /** @export */ y: _glBindFramebuffer,
  /** @export */ j: _glBindTexture,
  /** @export */ ha: _glBindVertexArrayOES,
  /** @export */ fb: _glBlendEquation,
  /** @export */ eb: _glBlendEquationSeparate,
  /** @export */ db: _glBlendFunc,
  /** @export */ O: _glBlendFuncSeparate,
  /** @export */ k: _glBufferData,
  /** @export */ x: _glBufferSubData,
  /** @export */ cb: _glCheckFramebufferStatus,
  /** @export */ ga: _glClear,
  /** @export */ fa: _glClearColor,
  /** @export */ ea: _glCompileShader,
  /** @export */ bb: _glCreateProgram,
  /** @export */ da: _glCreateShader,
  /** @export */ q: _glDeleteBuffers,
  /** @export */ N: _glDeleteProgram,
  /** @export */ ca: _glDeleteShader,
  /** @export */ ba: _glDeleteTextures,
  /** @export */ ab: _glDeleteVertexArraysOES,
  /** @export */ n: _glDisable,
  /** @export */ i: _glDisableVertexAttribArray,
  /** @export */ aa: _glDrawElements,
  /** @export */ $a: _glDrawElementsInstanced,
  /** @export */ m: _glEnable,
  /** @export */ h: _glEnableVertexAttribArray,
  /** @export */ _a: _glFramebufferTexture2D,
  /** @export */ p: _glGenBuffers,
  /** @export */ Za: _glGenFramebuffers,
  /** @export */ M: _glGenTextures,
  /** @export */ Ya: _glGenVertexArraysOES,
  /** @export */ Xa: _glGenerateMipmap,
  /** @export */ c: _glGetIntegerv,
  /** @export */ Wa: _glGetProgramInfoLog,
  /** @export */ Va: _glGetProgramiv,
  /** @export */ $: _glGetShaderInfoLog,
  /** @export */ _: _glGetShaderiv,
  /** @export */ Ua: _glGetString,
  /** @export */ f: _glGetUniformLocation,
  /** @export */ w: _glIsEnabled,
  /** @export */ Ta: _glIsProgram,
  /** @export */ Sa: _glLinkProgram,
  /** @export */ L: _glPixelStorei,
  /** @export */ Z: _glScissor,
  /** @export */ Y: _glShaderSource,
  /** @export */ K: _glTexImage2D,
  /** @export */ e: _glTexParameteri,
  /** @export */ Ra: _glUniform1f,
  /** @export */ v: _glUniform1i,
  /** @export */ X: _glUniform2fv,
  /** @export */ W: _glUniform3fv,
  /** @export */ V: _glUniform4fv,
  /** @export */ U: _glUniformMatrix4fv,
  /** @export */ J: _glUseProgram,
  /** @export */ l: _glVertexAttribDivisor,
  /** @export */ g: _glVertexAttribPointer,
  /** @export */ u: _glViewport,
  /** @export */ Qa: invoke_ii,
  /** @export */ I: invoke_iii,
  /** @export */ H: invoke_iiii,
  /** @export */ T: invoke_iiiii,
  /** @export */ Pa: invoke_iiiiiii,
  /** @export */ S: invoke_iiiiiiiiii,
  /** @export */ t: invoke_vi,
  /** @export */ o: invoke_vii,
  /** @export */ G: invoke_viii,
  /** @export */ Oa: _strftime,
  /** @export */ Na: _strftime_l
};

var wasmExports = createWasm();

var ___wasm_call_ctors = () => (___wasm_call_ctors = wasmExports["kh"])();

var _main = Module["_main"] = (a0, a1) => (_main = Module["_main"] = wasmExports["mh"])(a0, a1);

var _free = a0 => (_free = wasmExports["nh"])(a0);

var _malloc = a0 => (_malloc = wasmExports["oh"])(a0);

var _emscripten_builtin_memalign = (a0, a1) => (_emscripten_builtin_memalign = wasmExports["ph"])(a0, a1);

var _setThrew = (a0, a1) => (_setThrew = wasmExports["qh"])(a0, a1);

var __emscripten_tempret_set = a0 => (__emscripten_tempret_set = wasmExports["rh"])(a0);

var __emscripten_stack_restore = a0 => (__emscripten_stack_restore = wasmExports["sh"])(a0);

var __emscripten_stack_alloc = a0 => (__emscripten_stack_alloc = wasmExports["th"])(a0);

var _emscripten_stack_get_current = () => (_emscripten_stack_get_current = wasmExports["uh"])();

var ___cxa_is_pointer_type = a0 => (___cxa_is_pointer_type = wasmExports["vh"])(a0);

var dynCall_vi = Module["dynCall_vi"] = (a0, a1) => (dynCall_vi = Module["dynCall_vi"] = wasmExports["wh"])(a0, a1);

var dynCall_ii = Module["dynCall_ii"] = (a0, a1) => (dynCall_ii = Module["dynCall_ii"] = wasmExports["xh"])(a0, a1);

var dynCall_iii = Module["dynCall_iii"] = (a0, a1, a2) => (dynCall_iii = Module["dynCall_iii"] = wasmExports["yh"])(a0, a1, a2);

var dynCall_vif = Module["dynCall_vif"] = (a0, a1, a2) => (dynCall_vif = Module["dynCall_vif"] = wasmExports["zh"])(a0, a1, a2);

var dynCall_vii = Module["dynCall_vii"] = (a0, a1, a2) => (dynCall_vii = Module["dynCall_vii"] = wasmExports["Ah"])(a0, a1, a2);

var dynCall_viii = Module["dynCall_viii"] = (a0, a1, a2, a3) => (dynCall_viii = Module["dynCall_viii"] = wasmExports["Bh"])(a0, a1, a2, a3);

var dynCall_v = Module["dynCall_v"] = a0 => (dynCall_v = Module["dynCall_v"] = wasmExports["Ch"])(a0);

var dynCall_iiii = Module["dynCall_iiii"] = (a0, a1, a2, a3) => (dynCall_iiii = Module["dynCall_iiii"] = wasmExports["Dh"])(a0, a1, a2, a3);

var dynCall_viiii = Module["dynCall_viiii"] = (a0, a1, a2, a3, a4) => (dynCall_viiii = Module["dynCall_viiii"] = wasmExports["Eh"])(a0, a1, a2, a3, a4);

var dynCall_viiiifi = Module["dynCall_viiiifi"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viiiifi = Module["dynCall_viiiifi"] = wasmExports["Fh"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_viiiii = Module["dynCall_viiiii"] = (a0, a1, a2, a3, a4, a5) => (dynCall_viiiii = Module["dynCall_viiiii"] = wasmExports["Gh"])(a0, a1, a2, a3, a4, a5);

var dynCall_viifiiii = Module["dynCall_viifiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7) => (dynCall_viifiiii = Module["dynCall_viifiiii"] = wasmExports["Hh"])(a0, a1, a2, a3, a4, a5, a6, a7);

var dynCall_viiifii = Module["dynCall_viiifii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viiifii = Module["dynCall_viiifii"] = wasmExports["Ih"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_viff = Module["dynCall_viff"] = (a0, a1, a2, a3) => (dynCall_viff = Module["dynCall_viff"] = wasmExports["Jh"])(a0, a1, a2, a3);

var dynCall_i = Module["dynCall_i"] = a0 => (dynCall_i = Module["dynCall_i"] = wasmExports["Kh"])(a0);

var dynCall_viiff = Module["dynCall_viiff"] = (a0, a1, a2, a3, a4) => (dynCall_viiff = Module["dynCall_viiff"] = wasmExports["Lh"])(a0, a1, a2, a3, a4);

var dynCall_viifff = Module["dynCall_viifff"] = (a0, a1, a2, a3, a4, a5) => (dynCall_viifff = Module["dynCall_viifff"] = wasmExports["Mh"])(a0, a1, a2, a3, a4, a5);

var dynCall_viiffff = Module["dynCall_viiffff"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viiffff = Module["dynCall_viiffff"] = wasmExports["Nh"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_viif = Module["dynCall_viif"] = (a0, a1, a2, a3) => (dynCall_viif = Module["dynCall_viif"] = wasmExports["Oh"])(a0, a1, a2, a3);

var dynCall_fi = Module["dynCall_fi"] = (a0, a1) => (dynCall_fi = Module["dynCall_fi"] = wasmExports["Ph"])(a0, a1);

var dynCall_iiiii = Module["dynCall_iiiii"] = (a0, a1, a2, a3, a4) => (dynCall_iiiii = Module["dynCall_iiiii"] = wasmExports["Qh"])(a0, a1, a2, a3, a4);

var dynCall_iijii = Module["dynCall_iijii"] = (a0, a1, a2, a3, a4, a5) => (dynCall_iijii = Module["dynCall_iijii"] = wasmExports["Rh"])(a0, a1, a2, a3, a4, a5);

var dynCall_iiiiii = Module["dynCall_iiiiii"] = (a0, a1, a2, a3, a4, a5) => (dynCall_iiiiii = Module["dynCall_iiiiii"] = wasmExports["Sh"])(a0, a1, a2, a3, a4, a5);

var dynCall_viiiiii = Module["dynCall_viiiiii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_viiiiii = Module["dynCall_viiiiii"] = wasmExports["Th"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_iiiiiiiiii = Module["dynCall_iiiiiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) => (dynCall_iiiiiiiiii = Module["dynCall_iiiiiiiiii"] = wasmExports["Uh"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9);
...
var dynCall_iiiiiii = Module["dynCall_iiiiiii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiiii = Module["dynCall_iiiiiii"] = wasmExports["Wh"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_iiiiiiii = Module["dynCall_iiiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7) => (dynCall_iiiiiiii = Module["dynCall_iiiiiiii"] = wasmExports["Xh"])(a0, a1, a2, a3, a4, a5, a6, a7);

var dynCall_jiji = Module["dynCall_jiji"] = (a0, a1, a2, a3, a4) => (dynCall_jiji = Module["dynCall_jiji"] = wasmExports["Yh"])(a0, a1, a2, a3, a4);

var dynCall_ji = Module["dynCall_ji"] = (a0, a1) => (dynCall_ji = Module["dynCall_ji"] = wasmExports["Zh"])(a0, a1);

var dynCall_vffff = Module["dynCall_vffff"] = (a0, a1, a2, a3, a4) => (dynCall_vffff = Module["dynCall_vffff"] = wasmExports["_h"])(a0, a1, a2, a3, a4);

var dynCall_vf = Module["dynCall_vf"] = (a0, a1) => (dynCall_vf = Module["dynCall_vf"] = wasmExports["$h"])(a0, a1);

var dynCall_viiiiiiiii = Module["dynCall_viiiiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9) => (dynCall_viiiiiiiii = Module["dynCall_viiiiiiiii"] = wasmExports["ai"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9);

var dynCall_vff = Module["dynCall_vff"] = (a0, a1, a2) => (dynCall_vff = Module["dynCall_vff"] = wasmExports["bi"])(a0, a1, a2);

var dynCall_viiiiiii = Module["dynCall_viiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7) => (dynCall_viiiiiii = Module["dynCall_viiiiiii"] = wasmExports["ci"])(a0, a1, a2, a3, a4, a5, a6, a7);

var dynCall_vfi = Module["dynCall_vfi"] = (a0, a1, a2) => (dynCall_vfi = Module["dynCall_vfi"] = wasmExports["di"])(a0, a1, a2);

var dynCall_vifff = Module["dynCall_vifff"] = (a0, a1, a2, a3, a4) => (dynCall_vifff = Module["dynCall_vifff"] = wasmExports["ei"])(a0, a1, a2, a3, a4);

var dynCall_viffff = Module["dynCall_viffff"] = (a0, a1, a2, a3, a4, a5) => (dynCall_viffff = Module["dynCall_viffff"] = wasmExports["fi"])(a0, a1, a2, a3, a4, a5);

var dynCall_viiiiiiiiii = Module["dynCall_viiiiiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10) => (dynCall_viiiiiiiiii = Module["dynCall_viiiiiiiiii"] = wasmExports["gi"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10);

var dynCall_viiiiiiiiiii = Module["dynCall_viiiiiiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11) => (dynCall_viiiiiiiiiii = Module["dynCall_viiiiiiiiiii"] = wasmExports["hi"])(a0, a1, a2, a3, a4, a5, a6, a7, a8, a9, a10, a11);

var dynCall_viifi = Module["dynCall_viifi"] = (a0, a1, a2, a3, a4) => (dynCall_viifi = Module["dynCall_viifi"] = wasmExports["ii"])(a0, a1, a2, a3, a4);

var dynCall_iidiiii = Module["dynCall_iidiiii"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iidiiii = Module["dynCall_iidiiii"] = wasmExports["ji"])(a0, a1, a2, a3, a4, a5, a6);
...
var dynCall_iiiiiiiii = Module["dynCall_iiiiiiiii"] = (a0, a1, a2, a3, a4, a5, a6, a7, a8) => (dynCall_iiiiiiiii = Module["dynCall_iiiiiiiii"] = wasmExports["li"])(a0, a1, a2, a3, a4, a5, a6, a7, a8);

var dynCall_iiiiij = Module["dynCall_iiiiij"] = (a0, a1, a2, a3, a4, a5, a6) => (dynCall_iiiiij = Module["dynCall_iiiiij"] = wasmExports["mi"])(a0, a1, a2, a3, a4, a5, a6);

var dynCall_iiiiid = Module["dynCall_iiiiid"] = (a0, a1, a2, a3, a4, a5) => (dynCall_iiiiid = Module["dynCall_iiiiid"] = wasmExports["ni"])(a0, a1, a2, a3, a4, a5);
...
var _asyncify_start_unwind = a0 => (_asyncify_start_unwind = wasmExports["qi"])(a0);

var _asyncify_stop_unwind = () => (_asyncify_stop_unwind = wasmExports["ri"])();

var _asyncify_start_rewind = a0 => (_asyncify_start_rewind = wasmExports["si"])(a0);

var _asyncify_stop_rewind = () => (_asyncify_stop_rewind = wasmExports["ti"])();

var ___emscripten_embedded_file_data = Module["___emscripten_embedded_file_data"] = 6461472;
