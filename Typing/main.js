...
var wordNode = document.getElementById("rectangle");
var wordContainerNode = document.getElementById("wordContainer");
var hasPulsed = false;
var newExcerciseWord = "";
var currentCharInd = 0;
var guessedWord = "";

var moveOnFailure = true;
var canUseBackspace = true;
    ...
    function redrawWords() {
        ...
        for (var pInd = 0; pInd < pars.length; ++pInd) {
            ...
            for (var sInd = 0; sInd < subwords.length; ++sInd) {
                ...
                // var wordRect = document.createElement("span");
                // wordRect.id = "word" + sInd;
                // wordRect.className = "wordRectangle";
